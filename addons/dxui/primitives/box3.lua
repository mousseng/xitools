...
function box3.new()
    ...
    b.fgRect = ffi.new('RECT', { 0, 0,  64, 16 })
    ...
    function b:size(w, h)
        ...
        self.fgRect.left = 0
        self.fgRect.top = 0
        self.fgRect.right = math.floor(w / 2)
        self.fgRect.bottom = h
    ...
    function b:fg(d3dColor)
        self.fgColor = d3dColor
        return self
    end
    ...
    function b:draw(dxui)
        ...
        sprite:Draw(self.texture, self.fgRect, dxui.scale, nil, 0.0, self.position, self.fgColor)
